...
{
  { PA_PRINT, "harold", 1, 1},
  { PA_SCROLL_UP, "jhonatan_U", 5, 1},
  { PA_SCROLL_DOWN, "hola_D", 5, 1 },
  { PA_SCROLL_LEFT, "hoa_L", 5, 1 },
  ...
  { PA_SCROLL_DOWN_RIGHT, "JOHANNA", 7, 1 },
#endif
#if ENA_GROW
  { PA_GROW_UP, "HAROLD", 7, 1 },
  { PA_GROW_DOWN, "JHONATAN", 7, 1 },
#endif
};
